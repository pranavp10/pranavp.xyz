const Quote = () => {
  ...
  return (
    <div className=" relative px-4 py-10  border border-primary-white-50 rounded-xl">
      <svg
        aria-hidden="true"
        width="105"
        height="78"
        className="absolute top-6 left-6 fill-primary-white-100"
      >
      ...
      <p className="z-10 relative italic text-pretty font-mono font-medium text-primary-white-300">
        “{quote}”
      </p>
